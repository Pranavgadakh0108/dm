      ...
      child: Scaffold(
        ...
        drawer: Consumer<UserProfileProvider>(
          builder: (context, provider, child) {
            return AppDrawer(
              username: provider.userName.isNotEmpty ? provider.userName : 'Guest',
              phoneNumber: provider.userMobile.isNotEmpty ? provider.userMobile : 'Not available',
            );
          },
        ),
        appBar: AppBar(
              ...
              builder: (context, provider, child) {
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => MyWalletScreen(walletBalance: provider.userWallet.toString(),)),
                    );
                  },
                  child: Row(
                    children: [
