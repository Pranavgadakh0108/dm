...
class _LoginScreenState extends State<LoginScreen> {
  ...
  int step = 1; // 1 = Mobile only, 2 = Existing User (Password), 3 = New User (Name + Password)
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                CustomPhoneField(controller: mobileController),
                SizedBox(height: screenHeight * 0.025),
                ...
                if (step == 1 || step == 2) // hide this when inside progressive flow
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Column(
